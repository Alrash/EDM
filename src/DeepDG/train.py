...
def get_args():
    ...
    parser.add_argument("--level", "-l", type=int, default=0, help="0: ERM, 1: +Inter, 2: +Extra")
    parser.add_argument("--adv_hard", action='store_true')

    parser.add_argument("--sagm_alpha", type=float, default=1e-3)
...
if __name__ == '__main__':
    ...
    opt, sch = adjust_optimizer_scheduler(algorithm, optimizer=opt, scheduler=sch, args=args)
